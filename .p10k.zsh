# Generated by Powerlevel10k configuration wizard on 2025-02-22 at 08:03 MSK.
...
# angled separators, blurred heads, blurred tails, 2 lines, disconnected, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=34  
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=256
  ...
  # Don't shorten directories that containany of these files. They are anchors.
  local anchor_files=(
    .bzr
    .citc
    .git
